    ...
    return (<div key={book.bookId}
     ...
     <div className="flex flex-row sm:block hover-img">
      ...
      <div className="py-0 sm:py-3 pl-3 sm:pl-0">
       ...
       <p className="md:block text-gray-600 leading-tight mb-1">{book.author} <span
        className="md:inline-block text-gray-400 leading-tight mb-1">, {book.date} </span></p>
       <span
        className="text-gray-500 inline-block h-3 border-l-2 border-red-600 mr-2"></span>Reading
      </div>
     </div>
    </div>)
   })}
